...
namespace NetCore3MVC.Migrations
{
    ...
    [Migration("20221119061555_addedAvatarPath")]
    partial class addedAvatarPath
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetCore3MVC.Models.FileType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("NetCore3MVC.Models.MediaFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("NetCore3MVC.Models.MediaFile", b =>
                {
                    b.HasOne("NetCore3MVC.Models.New", null)
                        .WithMany("FilesPaths")
                        .HasForeignKey("NewId");

                    b.HasOne("NetCore3MVC.Models.FileType", "Type")
                        .WithMany()
